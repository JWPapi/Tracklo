  ...
  <>
    ...
    <div className="h-screen flex justify-between flex-col">
      <div className="max-w-4xl mx-auto prose pb-96">
        ...
        <p>By accessing this Website, accessible from https://tracklo.io, you are agreeing to be bound by these Website
        ...
        <p>Exalting GmbH or its suppliers will not be hold accountable for any damages that will arise with the use or
           inability to use the materials on Exalting GmbH’s Website, even if Exalting GmbH or an authorize
        ...
        <p>The materials appearing on Exalting GmbH’s Website may include technical, typographical, or photographic
           errors. Exalting GmbH will not promise that any of the materials in this Website are accurate, complete, or
           current. Exalting GmbH may change the materials contained on its Website at any time without notice. Exalting
           GmbH does not make any commitment to update the materials.
        </p>

        <h2>6. Links</h2>

        <p>Exalting GmbH has not reviewed all of the sites linked to its Website and is not responsible for the contents
           of any such linked site. The presence of any link does not imply endorsement by Exalting GmbH of the site.
           The use of any linked website is at the user’s own risk.
        </p>

        <h2>7. Site Terms of Use Modifications</h2>

        <p>Exalting GmbH may revise these Terms of Use for its Website at any time without prior notice. By using this
...
Imprint.noDrawer = () => true
Imprint.noLogin = () => true
