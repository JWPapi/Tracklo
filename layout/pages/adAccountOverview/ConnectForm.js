        ...
        <div className="mt-3 text-center sm:mt-5">
          ...
          <div className="mt-2">
            <p className="text-sm text-gray-500">
              To display your Ads Overview based on First-Party data we need a connection to your shopify store.
            </p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="input-div">
            <label htmlFor="name" className="label">
              <span className="label-text text-base-300"> Your Shopify Store Name</span>
            </label>
            <input type="text"
                   name="shopName"
          ...
          <div className="w-100 text-center">
            <Link href="https://craftybase.com/images/blog/post/how-to-find-your-shopify-storefront-address-screenshot1.png">
              <a target="_blank" className="label-text-alt text-base-100 cursor-pointer"> What is my Shopify Store
                                                                                          Name?</a> </Link>
          </div>
          <div className="mt-8 input-div">
            <label htmlFor="name" className="label">
              <span className="label-text text-base-300">Your Shopify API key</span>
            </label>
            <input type="text"
                   className="input input-bordered w-full max-w-xs"
                   name="token"
          ...
          <div className="w-100 text-center">
            <Link href="https://www.loom.com/share/ecec23285a6345ca9ac7c5a155178ec0">
              <a className="label-text-alt text-base-100 cursor-pointer" target="_blank"> How to get my Shopify API
                                                                                          key?</a> </Link>
          </div>
          <button type="submit"
